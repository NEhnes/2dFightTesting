...
namespace _2dFightTesting
{
    public class Attack
    {
        ...
        public Attack(string _name, int _startup, int _active, int _recovery,
                      int _hitstun, int _hitstop,
                      List<Rectangle> _hitboxes, List<Rectangle> _hurtboxes, List<Image> _frames)
        {
            Name = _name;
